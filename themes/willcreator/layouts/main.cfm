		...
		<div class="wrap site-head__bar" style="justify-content: flex-start;">
			<div class="brand-logo">
				<a class="brand" href="/" aria-label="#encodeForHTML( args.site.getName() )#">
                    <img src="https://willcreator.com.au/sites/default/themes/EstateTheme/assets/images/wc-logo.png" alt="#encodeForHTML( args.site.getName() )#" />
                </a>
			...
			<div class="site-foot__grid">
				<div class="site-foot__brand">
					<a class="brand" href="/" style="color:##fff">
						...
						<img src="https://willcreator.com.au/sites/default/themes/EstateTheme/assets/images/wc-logo.png" alt="Will Creator" />
					</a>

/**
 * Give existing owner roles the Service Areas permissions.
 */
component {

	variables.SLUGS = [ "serviceareas.view", "serviceareas.manage" ];
		...
		for ( var slug in variables.SLUGS ) {
			queryExecute(
				...
				",
				{
					...
					view      : { value : "serviceareas.view", cfsqltype : "cf_sql_varchar" },
					manage    : { value : "serviceareas.manage", cfsqltype : "cf_sql_varchar" },
